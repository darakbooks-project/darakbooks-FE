...
const ModalOverlay = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className='fixed bg-[white] shadow-[0_2px_8px_rgba(0,0,0,0.6)] z-30 p-4 rounded-[0.875rem] inset-x-0 w-4/5 animate-slideDown overflow-hidden top-[50%] mx-auto translate-y-1/2'>
      {children}
    </div>
  );
};
