...
const BookRecommendGuide = () => {
  ...
  return (
    <div className='h-full'>
      <div className='flex flex-col items-center px-5 justify-between h-full bg-[url(/images/bookRecommend/background1.svg)] bg-no-repeat bg-cover bg-center'>
        <Header className='pt-12 pl-0' />
        <section>
          <h1 className='mb-3 text-clamp2xl text-center font-semibold text-main'>
            어떤 책을 추천해드릴까요?
          </h1>
          <h3 className='font-medium text-[#707070] text-center pb-5 text-clampSm'>
