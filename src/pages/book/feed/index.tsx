    ...
    <AuthRequiredPage>
      <div className='flex flex-col bg-[#fbfbfb] gap-4  py-16'>
        <section className='flex items-center justify-center '>
          <button>&lt;</button>
          <div className='text-[15px] text-[#232323] px-4'>2023.05.26</div>
          <button>&gt;</button>
        </section>
        <section className='flex items-center justify-between w-full h-10 px-6'>
          <article className='flex items-center'>
            <div className='h-10 w-10 border mr-2 rounded-[50%] border-solid border-[black]'>
              <Image
                src=''
                alt='프로필 이미지'
                width='0'
        ...
        <section className='w-full h-[22rem] border border-solid border-[green]'>
          <Image
            src=''
            alt='피드 이미지'
            width='0'
        ...
        <article className='w-full leading-[160%] text-[15px] rounded-md px-6'>
          이 책을 읽고 마음에 깊이 와 닿았던 부분이 있습니다. 지금 이 순간
          밖에는 살지 못한다. 어쨌든 아침에 눈을 뜨면 오늘이라는 날을 위해 산다.
          할 수 있는 건 그것 뿐이다. 인간의 가치는 생산성이 아니라 산다는 데
          있다. 지금 살아 있다는 건 감사한 일이다. 과걸 돌아보며 후회하거나
          앞날을 생각하며 불안해 할 이유가 없다. 후회하지도 불안해 하지도 말고
          오늘이라는 날을 한발한발 내디디며 살아가자.
        </article>
        ...
        <section className='flex flex-col w-full px-6'>
          ...
          <article className='h-24 flex gap-4 p-4 rounded-md bg-[#ffffff]'>
