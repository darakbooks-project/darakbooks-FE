          ...
          <section className='flex flex-col gap-4'>
            ...
            <div className='flex items-center justify-end'>
              ...
              <label htmlFor='calendar'>
                {startDate ? (
                  <button className='w-[12rem] flex justify-end h-8 text-[14px] text-[#333333] cursor-pointer'>
                    완독일_ {startDate.toLocaleDateString('ko')}
                  </button>
                ) : (
                  <button className='w-[6.5rem] text-[14px] text-[#333333] flex justify-center items-center h-8 border rounded-[50px] border-solid border-[#c1c1c1] cursor-pointer'>
                    완독일 기록
                  </button>
                )}
              </label>
