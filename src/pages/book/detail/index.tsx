...
const BookDetailPage = () => {
  return (
    <div className='flex flex-col gap-2.5 pb-2.5 '>
      <section className='h-[30rem] border border-solid border-[red]'>
      ...
      <section className='border p-4 border-solid border-[green]'>
      ...
      <section className='border p-4 border-solid border-[black]'>
        <h2 className='not-italic font-bold text-xl leading-[29px] mb-4'>
          관련 기록
        </h2>
      ...
      <section className='flex justify-evenly items-center w-full px-0 py-4'>
